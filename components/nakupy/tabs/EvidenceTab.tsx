      ...
      if (purchaseFields.includes(field)) {
        ...
        if (field === "sell_price_total") {
          ...
          if (existingSales && existingSales.length > 0) {
            ...
            // Create new sale
            const sellPricePerTicket = newSellTotal / row.quantity;
            ...
            // Update purchase status to sold
