  ...
  return (
    <div>
      <div style={{ display: "flex", gap: 8, marginBottom: 24 }}>
        {[
          { id: "web", label: "Chrome Launcher Web" },
          { id: "app", label: "Chrome Launcher App" },
        ].map(tab => (
          <button
            key={tab.id}
            onClick={() => setActiveTab(tab.id as "web" | "app")}
            style={{
              padding: "8px 20px",
              background: activeTab === tab.id ? "#ffffff" : "transparent",
              border: activeTab === tab.id ? "none" : "1px solid #2a2a2a",
              borderRadius: 8,
              color: activeTab === tab.id ? "#000" : "#ededed",
              fontWeight: 600,
              fontSize: 13,
              cursor: "pointer",
            }}
        ...
        <div style={{ color: "#ededed" }}>
          ...
          <div style={{ fontSize: 13, color: "#a0a0a0" }}>
            ...
            {[
              ...
              "Spusťte soubor refresh_bot_launcher_mac.py dvojklikem",
